...
/* ── Syllabus rows — replace pdfLink with actual file paths ── */
const syllabusRows = [
  { id: 1, title: "B.Pharm Syllabus",   pdfLink: "https://cdn.ccsuniversity.ac.in/public/pdf/2026/03/Syllabus_B_Pharm_CSOP.pdf" },
];
    ...
    <div className="w-full bg-gradient-to-br from-[#0a1e38] to-[#1a3a6b] py-14 px-4 sm:px-6 lg:px-8">
          <div className="max-w-screen-xl mx-auto text-center">
              ...
              <p className="mt-5 text-blue-200 text-sm sm:text-base max-w-xl mx-auto leading-relaxed">
                The syllabus provides a comprehensive outline of subjects, course structure, and academic expectations.
              </p>
          </div>
        </div>
