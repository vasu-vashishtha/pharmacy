...
const DiscriminationItem = [
  { id: 1, title: "Anti Discrimination Committee",   pdfLink: "https://cdn.ccsuniversity.ac.in/public/pdf/2026/03/Anti_Discrimination_Committee_CSOP_2023_24.pdf" },
];
    ...
    <>
      <div className="w-full bg-gradient-to-br from-[#0a1e38] to-[#1a3a6b] py-14 px-4 sm:px-6 lg:px-8">
          <div className="max-w-screen-xl mx-auto text-center">
              ...
              The Anti-Discrimination Committee works to promote equality and prevent discrimination within the campus community.
              </p>
          </div>
        </div>
