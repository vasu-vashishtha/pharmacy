...
const GenderItem = [
  { id: 1, title: "Gender Sensitization Committee",   pdfLink: "https://cdn.ccsuniversity.ac.in/public/pdf/2026/03/Gender_Sensitization_Committee_CSOP_2023_24.pdf" },
];
    ...
    <>
      <div className="w-full bg-gradient-to-br from-[#0a1e38] to-[#1a3a6b] py-14 px-4 sm:px-6 lg:px-8">
          <div className="max-w-screen-xl mx-auto text-center">
              ...
              The Gender Sensitization Committee promotes awareness, equality, and a safe environment for all genders on campus.
              </p>
          </div>
        </div>
