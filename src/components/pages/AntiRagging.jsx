...
const AntiRaggingItem = [
  { id: 1, title: "Anti Ragging Committee",   pdfLink: "https://cdn.ccsuniversity.ac.in/public/pdf/2026/03/Anti_Ragging_Committee_CSOP_2023_24.pdf" },
];
      ...
      <div className="w-full bg-gradient-to-br from-[#0a1e38] to-[#1a3a6b] py-14 px-4 sm:px-6 lg:px-8">
          <div className="max-w-screen-xl mx-auto text-center">
              ...
              <p className="mt-5 text-blue-200 text-sm sm:text-base max-w-xl mx-auto leading-relaxed">
                The Anti-Ragging Committee ensures a safe and respectful campus environment by strictly preventing any form of ragging
              </p>
          </div>
        </div>
